...
class Stemmer {
	...
	public static void main() {
		...
		File dir = new File(Constants.PATH_ORIGINAL_CORPUS);
		...
		for (int i = 0; i < files.length; i++) {
			try {
				...
				PrintWriter dataOutputStream = new PrintWriter(new FileOutputStream(new File(Constants.PATH_STEMMED_CORPUS+"/"+files[i].getName())));
