...
public class GenerateCorpusJavaRanchForumThreadInFile {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < files.length; i++) {
			...
			try {
				...
				if (filenameNum < 10) {
					file2 = new File("C:/Users/Administrator/Desktop/corpusfinal_file_thread/0000"+ filenameNum + ".txt");
				}
				if (filenameNum >= 10 && filenameNum < 100) {
					file2 = new File("C:/Users/Administrator/Desktop/corpusfinal_file_thread/000"+ filenameNum + ".txt");
				}
				if (filenameNum >= 100 && filenameNum < 1000) {
					file2 = new File("C:/Users/Administrator/Desktop/corpusfinal_file_thread/00"+ filenameNum + ".txt");
				}
				if (filenameNum >= 1000 && filenameNum < 10000) {
					file2 = new File("C:/Users/Administrator/Desktop/corpusfinal_file_thread/0"+ filenameNum + ".txt");
				}
				if (filenameNum >= 10000) {
					file2 = new File("C:/Users/Administrator/Desktop/corpusfinal_file_thread/"+ filenameNum + ".txt");
				}
				...
				while ((str = reader.readLine()) != null) {
					...
					if (added == true) {
						...
						if (str.contains("<div class=\"mobilePostText\">")) {
							str = str.replaceAll("<div class=\"mobilePostText\">", "");
						}
						if (str.contains("<div class=\"mobilePostBody\">")) {
							str = str.replaceAll("<div class=\"mobilePostBody\">", "");
						}
						if (str.contains("<br />")) {
